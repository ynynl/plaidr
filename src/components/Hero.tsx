    ...
    <div className="hero">
      ...
      <div className="hero-content">
        ...
        <p className="hero-description">
          Transform your photos into unique plaid designs with colors extracted from your images.
          Create stunning tartan, madras, or net patterns in seconds.
        </p>
        <a 
          href="https://github.com/ynynl/plaidr" 
          target="_blank" 
